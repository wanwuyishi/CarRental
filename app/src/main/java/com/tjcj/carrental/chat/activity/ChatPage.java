...
import com.tjcj.carrental.chat.adapter.ChatMessageAdapter;
import com.tjcj.carrental.chat.main.MainActivity;
import com.tjcj.carrental.chat.main.SystemMessage;
import com.tjcj.carrental.chat.util.CommonUtils;
import com.tjcj.carrental.chat.util.GotyeVoicePlayClickPlayListener;
import com.tjcj.carrental.chat.util.ProgressDialogUtil;
import com.tjcj.carrental.chat.util.SendImageMessageTask;
import com.tjcj.carrental.chat.util.ToastUtil;
import com.tjcj.carrental.chat.util.URIUtil;
import com.tjcj.carrental.chat.view.RTPullListView;
...
//        findViewById(R.id.back).setOnClickListener(this);
    ...
    private void sendTextMessage(String text) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            //////////////////////////////////////////////////
//			GotyeMessage zxc = null;
//			GotyeUser a = new GotyeUser("yyy");
//			GotyeUser b = new GotyeUser("2ghk");
//			Log.d("zxc", "  对话人"+currentLoginUser.getName()+"  对话人"+o_user.getName());
            if (chatType == 0) {
                toSend = GotyeMessage.createTextMessage(currentLoginUser,
                        o_user, text);
//				zxc = GotyeMessage.createTextMessage(a,
//						b, "测试");
            } else if (chatType == 1) {
                toSend = GotyeMessage.createTextMessage(currentLoginUser,
                        o_room, text);
...
//				zxc.putExtraData(extraStr.getBytes());
            }

            // putExtre(toSend);
            int code = api.sendMessage(toSend);
//			int code1 = api.sendMessage(zxc);
            Log.d("", String.valueOf(code));
            adapter.addMsgToBottom(toSend);
//			adapter.addMsgToBottom(zxc);
            refreshToTail();
        }
    }
